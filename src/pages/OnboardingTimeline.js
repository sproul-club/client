    ...
    <div className="onboarding">
      ...
      <div className="imageContainer">
        ...
        <div className="caption-text">
          <p>
            On your Master Application Timeline, you can see all of your
            clubs' events for the recruitment season to help you plan 
            accordingly. Just click on the event itself to find more
            information.
          </p>
        </div>

        <div className="fifth">
            <button id="get-started-button" onClick={close}> Get Started! </button>
        </div>
