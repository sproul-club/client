    ...
    <div className="onboarding">
      ...
      <div className="imageContainer">
        ...
        <div className="caption-text">
          <p>
            This will no longer be displayed in future logins
          </p>
        </div>
        <br>
        </br>
        <div className="iamsure">
            <button id="i-am-sure-button" onClick={close}> I am sure</button>
        </div>
        <div className="nevermind">
            <button id="nevermind-button" onClick={closeOnlySkip}> Never mind! Bring me back</button>
        </div>
