...
const StudentLoginForm = ({ login, history, isAuthenticated }) => {
  // user inputs
  ...
  return (
    <form className="formGroup">
      ...
      <GoogleLogin
        clientId="512601493220-079ms6b5h96n5ajm7ohj4h22l6ln2pm5.apps.googleusercontent.com"
        buttonText="Login"
...
export default connect(mapStateToProps, { login })(withRouter(StudentLoginForm));
