                ...
                <div className='favorites-content'>
                    <div className='favorites-text'>
                        ...
                        <div className="subtext">
                            <span>You have favorited <b>{student.favorited_clubs.length}</b> clubs so far,<br/>and <b>{student.club_board.interested_clubs.length}</b> are listed as <b>Interested</b> in your Application Tracker Board!</span>
                        </div>
...
export default connect(mapStateToProps, {searchClubs,
    ...
    loadMoreOrgs,
    setFormDetails,
    loadMoreClubs})(withRouter(Favorites));