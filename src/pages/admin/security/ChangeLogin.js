    ...
    if (editingMode) {
      return (
        <div>
          ...
          <div className={conError}>Passwords don't match or left blank.</div>
        </div>
      );
    } else {
      return (
  ...
  return (
    <div className="changeLogin">
      ...
      <div className="admin-text">
        Change your password - password must be at least 8 characters, include 1
...
export default connect(null, { updatePassword })(ChangeLogin);
